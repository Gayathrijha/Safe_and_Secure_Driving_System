...
def d_dtcn():
	...
	def function1(): 
		os.system("python Drowsiness-Detection\drowsiness_detection.py --shape_predictor Drowsiness-Detection\shape_predictor_68_face_landmarks.dat")
		exit()

	def function2(): 
		os.system("python Drowsiness-Detection\\android_cam.py --shape_predictor Drowsiness-Detection\shape_predictor_68_face_landmarks.dat")
		exit()
