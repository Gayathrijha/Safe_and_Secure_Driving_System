	...
	for (i, rect) in enumerate(rects): 
		...
		if EAR < EAR_THRESHOLD: 
			...
			if FRAME_COUNT >= CONSECUTIVE_FRAMES: 
				...
				playsound('C:/Users/DELL/Drowsiness-Detection/sound files/alarm.mp3')
				cv2.putText(frame, "DROWSINESS ALERT!", (270, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
		else: 
			if FRAME_COUNT >= CONSECUTIVE_FRAMES: 
				playsound('C:/Users/DELL/Drowsiness-Detection/sound files/warning.mp3')
			FRAME_COUNT = 0
		...
		if MAR > MAR_THRESHOLD:
			...
			playsound('C:/Users/DELL/Drowsiness-Detection/sound files/alarm.mp3')
			playsound('C:/Users/DELL/Drowsiness-Detection/sound files/warning_yawn.mp3')
